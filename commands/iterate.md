...
2. **Overwrite** the **Role** sentence with an updated summary reflecting the changed scope.
...
5. Update the matching line in `docs/overview.md` to `#in-progress` if it was `#done`.
