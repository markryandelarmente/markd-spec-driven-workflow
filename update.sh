...
echo "  ${CMD_PREFIX}markd:write-spec, ${CMD_PREFIX}markd:analyze, ${CMD_PREFIX}markd:implement, ${CMD_PREFIX}markd:iterate, ${CMD_PREFIX}markd:code-review, ${CMD_PREFIX}markd:rollback"
echo "  WORKFLOW.md"
echo ""
